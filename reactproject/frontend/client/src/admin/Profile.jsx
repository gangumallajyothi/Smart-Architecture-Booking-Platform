...
export default function AdminProfile({
  totalUsers    = 0,
  totalBookings = 0,
  onLogout,           // ✅ optional callback — parent can pass custom logout logic
}) {
  ...
  // ✅ totalUsers real-time ga badge lo show avutundi
  const STATS = [
    {
      ico: "👥", bg: "#eef2ff",
      n: totalUsers,
        ...
        <div className="pf-cover-card">
          <div className="pf-cover-band">
            ...
            <div className="pf-band-top-right">
              ...
              {/* ✅ Logout Button — blue, top-right corner */}
