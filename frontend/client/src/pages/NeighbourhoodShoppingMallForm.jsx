  ...
  return (
    <div className="container">
      ...
      <style>{`
        ...
        .card { background:white; padding:10px; border-radius:30px; flex:1; min-width: 0; box-shadow:0px 2px 6px rgba(0,0,0,0.1); }
        .card img { width:100%; height: 350px; object-fit: contain; border-radius:8px; }
