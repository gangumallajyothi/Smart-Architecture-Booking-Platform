...
const styles = `
  ...
  .ab-sec-desc{font-size:1rem;color:var(--gray-600);line-height:1.8;max-width:600px;margin:0 auto}
  ...
  .ab-steps{display:grid;grid-template-columns:repeat(3,1fr);gap:2rem;max-width:1200px;margin:0 auto}
  ...
  .ab-types-grid{display:grid;grid-template-columns:repeat(3,1fr);gap:1.8rem;max-width:1200px;margin:0 auto}
  ...
  .ab-values-grid{display:grid;grid-template-columns:repeat(4,1fr);gap:2rem;max-width:1200px;margin:0 auto}
  ...
  .ab-team-grid{display:grid;grid-template-columns:repeat(4,1fr);gap:2rem;max-width:1200px;margin:0 auto}
